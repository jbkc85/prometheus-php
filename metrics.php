...
# HELP promphp_fpm_proc_idle Outputs idle processes stat from phpfpm status
# TYPE promphp_fpm_proc_idle gauge
promphp_fpm_proc_idle{handler="{$php_sapi}"} {$phpfpm_info["idle processes"]}
# HELP promphp_fpm_proc_active Outputs active processes stat from phpfpm status
# TYPE promphp_fpm_proc_active gauge
promphp_fpm_proc_active{handler="{$php_sapi}"} {$phpfpm_info["active processes"]}
# HELP promphp_fpm_proc_available Outputs total processes stat from phpfpm status
# TYPE promphp_fpm_proc_available gauge
promphp_fpm_proc_available{handler="{$php_sapi}"} {$phpfpm_info["total processes"]}
